...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Login with user type, name, and email
    login(userType as "umum" | "kader", name, email) // Pass email here
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Masuk ke Lansia Care</h1>
          <p className="text-gray-600">Masuk untuk mengakses layanan Posyandu Lansia</p>
        </div>
